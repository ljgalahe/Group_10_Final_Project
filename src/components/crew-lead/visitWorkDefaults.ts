...
const SERVICE_MATERIALS: Record<string, string[]> = {
  ...
  "Lawn Mowing & Edging": ["Fuel Mix", "Trash Bags", "Edger Line / Blades"],
  Edging: ["Edger Line / Blades"],
  Trimming: ["Hedge Clippings Bags"],
  "Tree & Bush Trimming": ["Hedge Clippings Bags"],
...
const SERVICE_EQUIPMENT: Record<string, string[]> = {
  ...
  "Mulch & Landscape Beds": ["Mulch Blower", "Wheelbarrow"],
  "Sidewalk & Parking Lot Cleanup": ["Blower", "Trailer"],
  "Leaf & Debris Removal": ["Blower", "Rakes", "Trailer"],
  "Snow & Ice Clearing": ["Plow / Spreader", "PPE"],
};
...
const SERVICE_TASKS: Record<string, string[]> = {
  ...
  "Flower Beds & Seasonal Plants": ["Install Seasonal Color", "Top-Dress Beds"],
  "Detention Pond Maintenance": ["Clear Outlet", "Inspect Embankment"],
  "Irrigation Inspection": ["Run Zones", "Flag Broken Heads"],
  "Sprinkler & Watering Systems": ["Run Zones", "Flag Broken Heads"],
  ...
  "Mulch & Landscape Beds": ["Refresh Mulch Beds", "Pull / Treat Weeds"],
  "Sidewalk & Parking Lot Cleanup": [
    "Blow Walkways and Lot Edges",
    "Collect Litter",
  ],
  "Leaf & Debris Removal": ["Clear Leaves from Turf", "Haul Debris Off Site"],
  "Snow & Ice Clearing": ["Clear Priority Routes", "Treat Entrances"],
};
