...
export const SEED_INVOICE = {
  /** INV-0330 — May 2026 grounds, paid $4,200 */
  riversidePaid: "55555555-5555-5555-5555-000000000330",
  /** INV-0331 — June 2026 grounds, past due $4,200 */
  riversideJune: "55555555-5555-5555-5555-000000000331",
  /** INV-0553 — Mulch Installation extra work, past due $2,850 */
  riversideMulch: "55555555-5555-5555-5555-000000000553",
...
const OVERLAYS: Record<string, Overlay> = {
  [SEED_INVOICE.riversidePaid]: {
    ...
    checks: [
      ...
      { id: "pricing", label: "Pricing matches contract", passed: true, detail: "$4,200 monthly fee" },
    ...
    profit: { revenue: 4200, labor: 1260, materials: 315, equipment: 210, travelFuel: 105, other: 70 },
    exception: "None",
    ...
    explainableSummary:
      "This invoice covers the regular monthly maintenance fee of $4,200 for May 2026. All related work was completed and paid in full.",
    timeline: [
  ...
  [SEED_INVOICE.riversideJune]: {
    ...
    checks: [
      ...
      { id: "costs", label: "Labor and materials recorded", passed: true, detail: "Visit costs logged" },
      { id: "extra", label: "Extra work approved", passed: true, detail: "N/A — recurring only" },
      { id: "pricing", label: "Pricing matches contract", passed: true, detail: "$4,200 monthly fee" },
      { id: "active", label: "Contract was active", passed: true, detail: "Season open" },
    ...
    highRisk: false,
    whyDifferent: [
      { message: "Regular June monthly maintenance — still unpaid past due date.", kind: "warning" },
      { message: "Approved mulch work is billed separately on INV-0553 ($2,850).", kind: "info" },
    ],
    duplicateShield: { blocked: false, message: null },
    evidence: {
      contractRequirements: ["Mowing", "Edging", "Trimming"],
      scheduledService: "June monthly maintenance",
      crew: ["Alex Rivera", "Sam Ortiz", "Casey Ng"],
      arrival: "2026-06-02T07:50:00Z",
      completion: "2026-06-09T15:30:00Z",
      beforeImage: lawnMow.beforeImage,
      afterImage: lawnMow.afterImage,
      crewNotes: "Standard grounds pass — hedge trim at entrance completed.",
      materials: ["Fertilizer blend"],
      equipment: ["Mower", "Edger"],
      customerApproval: "Standing monthly authorization",
      extraWorkApproval: "N/A — see INV-0553 for mulch",
      customerAck: "Viewed; payment pending",
      relatedLines: ["Monthly maintenance — Riverside (June 2026)"],
    },
    explainableSummary:
      "This invoice is the regular monthly maintenance fee of $4,200 for June 2026. Related visits were completed; payment is past due. Mulch installation is billed on INV-0553.",
    timeline: [
      ...
      { id: "review", label: "Manager reviewed", at: "2026-06-10", done: true },
  ...
  [SEED_INVOICE.riversideMulch]: {
    property: "1200 University Ave, Oxford, MS",
    checks: [
      { id: "completed", label: "Service visit completed", passed: true, detail: "Entrance beds completed" },
      { id: "docs", label: "Crew documentation exists", passed: true, detail: "Notes on file" },
      ...
      { id: "pricing", label: "Pricing matches contract", passed: true, detail: "Approved extra work quote" },
      { id: "active", label: "Contract was active", passed: true, detail: "Season open" },
      { id: "dup", label: "Not billed previously", passed: true, detail: "One-time mulch WO" },
      { id: "evidence", label: "Service evidence attached", passed: true, detail: "Before/after mulch photos" },
    ],
    profit: { revenue: 2850, labor: 640, materials: 1180, equipment: 140, travelFuel: 60, other: 40 },
    exception: "Past due",
    highRisk: false,
    whyDifferent: [
      { message: "Approved mulch installation billed separately from monthly fee.", kind: "info" },
      { message: "Still unpaid — due 2026-07-25.", kind: "warning" },
    ],
    duplicateShield: { blocked: false, message: null },
    evidence: {
      contractRequirements: ["Extra work: Mulch Installation — Entrance Beds"],
      scheduledService: "Mulch install at entrance beds",
      crew: ["Alex Rivera", "Sam Ortiz", "Casey Ng"],
      arrival: "2026-06-09T08:00:00Z",
      completion: "2026-06-09T15:30:00Z",
      beforeImage: mulchBed.beforeImage,
      afterImage: mulchBed.afterImage,
      crewNotes: "Mulch installed at entrance beds.",
      materials: ["12 yd premium mulch"],
      equipment: ["Mulch blower", "Skid steer"],
      customerApproval: "Extra work order approved",
      extraWorkApproval: "Mulch WO approved 2026-05-20",
      customerAck: "Pending payment",
      relatedLines: ["Extra work: Mulch Installation — Entrance Beds"],
    },
    explainableSummary:
      "This invoice bills the approved mulch installation of $2,850 for Riverside entrance beds. Monthly maintenance is billed separately on INV-0331.",
    timeline: [
      { id: "sched", label: "Work scheduled", at: "2026-05-20", done: true },
      { id: "done", label: "Work completed", at: "2026-06-09", done: true },
      { id: "costs", label: "Costs recorded", at: "2026-06-09", done: true },
      { id: "review", label: "Manager reviewed", at: "2026-06-10", done: true },
      { id: "created", label: "Invoice created", at: "2026-06-01", done: true },
    ...
    paymentPromise: {
      ...
      promisedDate: "2026-07-15",
      contact: "Maria Chen",
      notes: "Board reviewing extras with June invoice",
      status: "broken",
    },
  },
  ...
  return [
    {
      ...
      contractId: "22222222-2222-2222-2222-222222222205",
      visitId: "33333333-3333-3333-3333-333333333308",
    },
    {
      id: "unbilled-2",
