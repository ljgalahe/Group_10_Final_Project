...
insert into customers (id, name, property_type, address, contact_name, contact_email, created_at) values
  ('11111111-1111-1111-1111-111111111101', 'Riverside Office Park', 'Office Park', '1200 River Rd, Austin, TX', 'Maria Chen', 'mchen@riverside-op.com', '2023-03-15 10:00:00+00'),
  ('11111111-1111-1111-1111-111111111102', 'Summit Retail Center', 'Retail Center', '450 Summit Blvd, Austin, TX', 'James Ortiz', 'jortiz@summitretail.com', '2024-01-10 10:00:00+00'),
  ('11111111-1111-1111-1111-111111111103', 'Harbor View HOA', 'HOA', '88 Harbor Ln, Austin, TX', 'Pat Simmons', 'psimmons@harborviewhoa.org', '2024-06-01 10:00:00+00'),
  ('11111111-1111-1111-1111-111111111104', 'Metro Industrial Complex', 'Industrial', '900 Industrial Dr, Austin, TX', 'Dana Brooks', 'dbrooks@metroindustrial.com', '2025-02-20 10:00:00+00');
